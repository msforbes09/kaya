...
// in runner/src/agent/destructive-patterns.json, the same list Kaya's runtime
...
const patterns = JSON.parse(fs.readFileSync(path.join(root, "runner/src/agent/destructive-patterns.json"), "utf8"));
